...
/**
 * Custom hook that creates a subtle "whoosh" sound effect on hover
 * using the Web Audio API with noise filtering for a soft swoosh effect.
 */
export function useHoverSound() {
  ...
  const play = useCallback(() => {
    ...
    try {
      ...
      // Generate filtered noise (pink-ish noise for softer sound)
      ...
      // Bandpass filter for "air" quality
      const bandpass = ctx.createBiquadFilter();
      bandpass.type = 'bandpass';
      bandpass.frequency.value = 1600;
      bandpass.Q.value = 0.6;

      // Gain envelope for smooth fade
