...
```bash
git clone https://github.com/srisomanaath/srisomanaath.git portfolio
cd portfolio
```
...
```bash
npx shadcn@latest add @srisomanaath/utils
npx shadcn@latest add @srisomanaath/book
npx shadcn@latest add @srisomanaath/modern-progress
npx shadcn@latest add @srisomanaath/pixel-icon
npx shadcn@latest add @srisomanaath/split-text-effect
npx shadcn@latest add @srisomanaath/view-magnifier
npx shadcn@latest add @srisomanaath/game-of-life
npx shadcn@latest add @srisomanaath/magical-mouse
```
